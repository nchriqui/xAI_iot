...
# python .\data-drifts-detection\D3.py <dataset> <size of the old data> <percentage of new data with respect to old> <threshold for auc>
...
# f.savefig("D3.png", bbox_inches='tight')
